...
<header>
    <nav>
        <div class="logo"><i class="fas fa-dumbbell"></i> SportConnect</div>
        <ul class="nav-links">
        ...
        <div class="auth-buttons">
            ...
            <?php else: ?>
                <a href="pages/login_sportif.php" class="btn btn-primary">Connexion Sportif</a>
                <a href="pages/login_coach.php" class="btn btn-secondary">Connexion Coach</a>
            <?php endif; ?>
        </div>
    </nav>
</header>
